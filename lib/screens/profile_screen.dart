...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    MutabaahController mutabaahController = Get.find<MutabaahController>();
                        ...
                        children: [
                          ...
                          Material(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Get.put(HomeController()).checkUpdate(
                                    isShowNotUpdateAvailable: true);
                              },
                            ),
                          ),
                          Material(
                            ...
                            child: ListTile(
                              ...
                              subtitle: const Text(
                                "Notifikasi harian jam 19:30",
                                style: TextStyle(fontSize: 12),
                              ),
                              trailing: Obx(() => Switch(
                                    value: mutabaahController
                                        .isNotificationEnabled.value,
                                    onChanged:
                                        mutabaahController.toggleNotification,
                                    activeColor: Utils.kPrimaryColor,
                                  )),
                              onTap: () {
                                mutabaahController.testNotification();
                              },
                            ),
                          ),
                          Material(
